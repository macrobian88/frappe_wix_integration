...
# get version from __version__ variable in wix_integration/wix_integration/__init__.py
from wix_integration.wix_integration import __version__ as version
