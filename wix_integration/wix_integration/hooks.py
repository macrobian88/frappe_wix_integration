...
app_description = "Bidirectional sync between Wix e-commerce and ERPNext"
...
after_install = "wix_integration.wix_integration.install.after_install"
...
doc_events = {
    "Item": {
        "after_insert": "wix_integration.wix_integration.api.sync_product_to_wix",
        "on_update": "wix_integration.wix_integration.api.sync_product_to_wix"
    }
}
...
scheduler_events = {
    "hourly": [
        "wix_integration.wix_integration.tasks.hourly"
    ],
    "daily": [
        "wix_integration.wix_integration.tasks.daily"
    ],
    "weekly": [
        "wix_integration.wix_integration.tasks.weekly"
    ]
}
